...
function About() {
	return (
		<section
			id='about'
			className='relative flex flex-col md:flex-row items-center gap-6 justify-center md:justify-evenly min-h-screen snap-start  p-5 max-w-7xl mx-auto text-[#F7F7F7]'
		>
			<h2 className='absolute top-24 text-gray-500 text-2xl tracking-[10px] md:tracking-[20px] uppercase'>
				ABOUT
			</h2>
			<motion.img
			...
			<div className='grid gap-2 text-center md:text-left'>
				<h4 className='text-xl font-semibold text-[#FAC213]'>
				...
				<p className='text-lg'>
					...
					experience in creating user interfaces such as Angular. Honed my
					skills in implementing features based on design specifications,
					collaborating with teams to integrate APIs and solve cross-browser
